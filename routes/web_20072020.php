...
Route::post('/checkcheckoutaddress', 'UI\MainController@checkcheckoutaddress');
	...
	Route::get('return-policy','UI\MainController@returnPolicy');
	Route::get('refund-policy','UI\MainController@refundPolicy');
	Route::get('cancellation-policy','UI\MainController@cancellationPolicy');
	...
	Route::get('cart-details/{products_id}/{cat_id}','UI\UserController@addtoCart');
	...
	// Doctor Controller 
	   ...
	   //forget Password website
        ...
        //Lab Test Controller
        	Route::get('popular-packages','UI\LabTestController@popularPackages'); 
