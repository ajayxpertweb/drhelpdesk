<div class="col-md-6"> 
	<div class="box box-primary">
		...
		<form action="{{url('language-submit')}}" method="post" enctype="multipart/form-data">
			{{ csrf_field() }}  
			<input type="hidden" class="form-control" name="languages_id" value="{{$result->languages_id}}"> 
			<div class="box-body"> 
				<div class="form-group">
					<label for="exampleInputEmail1">Language Name</label>
					<input type="text" class="form-control" name="language_name" value="{{$result->language_name}}">
					@error('language_name')
                     	<p>* {{ $message }}</p>
                	@enderror
				</div>  
