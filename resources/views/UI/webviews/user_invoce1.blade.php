	...
	<div>
		<table class="table">
				...
				<td style=" background-color: #eee;">₹{{$f}}</td>
                        ...
                        <tr>
				<td colspan="10" style="font-weight: 700; color: black; text-align: right;">For Appario Retail Private Ltd:<br><img src="images/signture.jpg" style="width: 100px;"> <br>Authorized Signatory</td>
			</tr>
                        <br><br>
                                </tbody>
                            </table>
