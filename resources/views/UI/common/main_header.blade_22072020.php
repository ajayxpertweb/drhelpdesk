            ...
            <div class="header__navbar-menu">
              <div class="main-menu">
                <ul class="main-menu__list">
                  ...
                  @if($sub_lab == null)
                    <li class="main-menu__item main-menu__item--submenu--megamenu main-menu__item--has-submenu"><a href="{{url('popular-packages')}}" class="main-menu__link">{{$lab->category_name}} <i class="fas fa-angle-down"></i></a>
                      <div class="main-menu__submenu">
                        <div class="main-menu__megamenu main-menu__megamenu--size--xxl">
                          <div class="megamenu">
                            <div class="row">
                              ...
                              <div class="col-2">
                                <ul class="megamenu__links megamenu-links megamenu-links--root">
                                  <li class="megamenu-links__item megamenu-links__item--has-submenu"><a class="megamenu-links__item-link" href="{{url('popular-packages')}}">{{$r->sub_category_name}}</a>
                                    <ul class="megamenu-links">
                  ...
                  @else
                    <li class="main-menu__item"><a href="{{url('popular-packages')}}" class="main-menu__link">{{$lab->category_name}} </a>
                  ...
                  @else
                    <li class="main-menu__item">
                      <a href="{{url('doctor-list/'.$doctor->categories_id)}}" class="main-menu__link">{{$doctor->category_name}}</a> 
                    </li>
                  @endif 
        ...
        <div class="header__indicators">  
            @if(Auth::check())
              ...
              <div class="indicator indicator--trigger--click">
                  <a href="{{url('/')}}" class="indicator__button"><span class="indicator__icon">
                      <img src="{{asset($image1)}}" alt="" style="height: 42px; width: 42px; border-radius: 20px;"></span> </span><span class="indicator__title">Hello, {{Auth::user()->name}}</span> <span class="indicator__value">My Account</span></a> 
            @else
                     ...
                     @endphp
                      ...
                      @elseif($temp_type[$products->products_id] == 3)
                        ...
                        <li class="dropcart__item">
                          ...
                          <button type="button" class="dropcart__item-remove"> 
                            <a href="{{url('/')}}" class="text-danger" onclick="removeProduct({{$temp_id[$products->id]}})"><i class="fas fa-times"></i></a>
                          </button>
                        </li>  
                        @if($products->offer_discount == null) 
                          <?php $total_amount1+=  
