						...
						<div class="product__body">
								...
								<div class="product-gallery__featured">
									...
									<div class="owl-carousel">
										<a href="{{asset($image->product_image)}}" target="_blank">
											@if(file_exists(asset($image->product_image)))
										...
										<a href="{{asset($r->product_image)}}" target="_blank">
											@if(file_exists(asset($r->product_image)))
										...
										<div class="product__rating-stars">
											<div class="rating">
												<div class="rating__body">
													{!! str_repeat(' <i class="fa fa-star" aria-hidden="true" style="color:#ea8330;"></i>', $product->rating ) !!}
                        							{!! str_repeat(' <i class="fa fa-star" aria-hidden="true" style="color:#ebebeb;"></i>', 5 - $product->rating ) !!} 
												</div>
											</div>
										</div>
							...
							<div class="product__tabs product-tabs product-tabs--layout--full">
								<ul class="product-tabs__list">
									...
									<li class="product-tabs__item"><a href="#product-tab-reviews">Reviews <span class="product-tabs__item-counter">{{$review->count()}}</span></a>
									</li>
								</ul>
