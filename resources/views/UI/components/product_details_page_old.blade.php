								...
								<div class="product-gallery__featured">
									...
									<div class="owl-carousel">
										<a href="{{asset($image->product_image)}}" target="_blank">
											@if(file_exists('http://lsne.in/dhd/public/{$image->product_image}'))
										...
										@foreach($image1 as $r)
										<a href="{{asset($r->product_image)}}" target="_blank">
											@if(file_exists('http://lsne.in/dhd/public/{$r->product_image}'))
						                      <img src="{{asset($r->product_image)}}" alt="">
						                    @else
						                      <img src="{{asset('UI/images/product_default1.png')}}" alt="">
						                    @endif 
										</a>
										...
										<div class="product__rating-stars">
											<div class="rating">
												<div class="rating__body">
													{!! str_repeat('<i class="fa fa-star" aria-hidden="true" style="color:##ffd333;"></i>', $product->rating) !!}
	                    							{!! str_repeat('<i class="fa fa-star-o" aria-hidden="true" style="color:#ffd333;"></i>', 5 - $product->rating) !!} 
								...
								<div class="product__info-card">
									<div class="product__info-body">
										...
										@if($product->extra_discount == null)
											 discount {{$product->extra_discount}} % 
										@else
											 discount {{$product->extra_discount}} % 
	      								@endif  
									...
									<ul class="shop-features__list">
										<li class="shop-features__item">
											...
											<div class="shop-features__info">
												...
												<div class="shop-features__item-subtitle">For orders from 799</div>
											</div>
										</li>
													...
													<ol class="reviews-list__content">
															...
															<div class="review">
																<div class="review__body">
																	<div class="review__avatar">
																		<img src="{{asset('UI/images/avatars/avatar-1-42x42.jpg')}}" alt="">
																	</div>
																	...
																	<div class="review__content typography">{{$r->comment}}</div>
																</div>
															</div>
														</li>
														@endforeach
														<!-- <li class="reviews-list__item">
															<div class="review">
																<div class="review__body">
																	<div class="review__avatar">
																		<img src="{{asset('UI/images/avatars/avatar-2-42x42.jpg')}}" alt="">
																	</div>
																	<div class="review__meta">
														...
														<li class="reviews-list__item">
															<div class="review">
																<div class="review__body">
																	<div class="review__avatar">
																		<img src="{{asset('UI/images/avatars/avatar-3-42x42.jpg')}}" alt="">
																	</div>
																	<div class="review__meta">
															...
															<div class="col-xxl-8 col-xl-10 col-lg-9 col-12">
																<div class="form-row">
																	...
																	<div class="form-group col-md-4">
																		...
																		<input type="text" class="form-control" id="review-author" placeholder="Your Name" name="user_name">
																	</div>
																	<div class="form-group col-md-4">
																		<label for="review-email">Email Address</label>
																		<input type="text" class="form-control" id="review-email" placeholder="Email Address" name="email">
																	</div>
																</div>
								              ...
								              <div class="product-card product-card--layout--grid"> 
								                <div class="product-card__image">
								                    ...
								                    <a href="{{url('/product-detail/'.$r->products_id)}}">
								                    	@if(file_exists('http://lsne.in/dhd/public/{$category}'))
