...
<div class="site__body">
			...
			<div class="block block-brands block-brands--layout--columns-6-full">
				...
				<!-- End Listing -->
					<div class="row">
						...
						<div class="col-md-6">
							<div class="_3-Klh _1lp7v"><div class="_1-Hc6"><button type="button" class="_2FE4Z h1H8I _2Jc-Z _3LBfS" style="width: 100%;" onclick="sidePop()">Upload Presciption</button></div>
					...
					<div class="row">
						<div class="col-md-3">
							<div>
								...
								<div class="_2XOfq">Every test booked via PharmEasy is conducted by an ISO or NABL certified lab that are 100% verified and trustworthy.</div>
							</div>
						</div>
						<div class="col-md-3">
							<div>
								...
								<div class="_2XOfq">With PharmEasy, you get a FREE sample pick-up* by professional phlebotomists from your home or preferred location.</div>
							</div>
						</div>
						<div class="col-md-3">
							<div>
						...
						<div class="col-md-3">
							<div>
								...
								<div class="_2XOfq">At PharmEasy, you save at every step! On diagnostic tests, get up to 70% OFF on various tests and test packages.</div>
							</div>
						</div>
					</div>
	...
	c0.4,0,0.8-0.3,0.8-0.8s-0.3-0.8-0.8-0.8h-2.5v-1.7H28c0.4,0,0.8-0.3,0.8-0.8s-0.3-0.8-0.8-0.8h-0.9v-1.7L29.6,21.9L29.6,21.9z" />
							...
							<div class="block-features__item-info">
								...
								<div class="block-features__item-subtitle">For orders from <i class="fas fa-rupee-sign"></i>499</div>
							</div>
						</li>
						<li class="block-features__item">
							<div class="block-features__item-icon">
