		...
		<div class="row">
			<!-- <div class="col-12 mb-3">
				...
				<div class="col-12 col-lg-8 col-xl-8">
					...
					@php
					    $disableitem = $type2totalitem > 0? "disabled" : "";
					@endphp
						...
						<div class="card-body card-body--padding--1">
							...
							<div class="checkout__payment-methods payment-methods">
								<ul class="payment-methods__list"> 
									...
									<!--</li>-->
									<li class="payment-methods__item">
										<label class="payment-methods__item-header"><span class="payment-methods__item-radio input-radio"><span class="input-radio__body"><input class="input-radio__input" name="payment_mode" type="radio" checked="checked"> <span class="input-radio__circle"></span> </span>
											</span><span class="payment-methods__item-title">Online Payment With Credit Card / Debit Card</span>
										</label>
										<div class="payment-methods__item-container">
									...
									<li class="payment-methods__item payment-methods__item--active">
										<label class="payment-methods__item-header"><span class="payment-methods__item-radio input-radio"><span class="input-radio__body"><input class="input-radio__input" name="payment_mode" type="radio" {{$disableitem}} value="COD" > <span class="input-radio__circle"></span> </span>
...
<div class="container">
  ...
  <button id="model-btn" style="display: none" type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Open Small Modal</button>
