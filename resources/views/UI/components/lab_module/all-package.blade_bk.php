               ...
               @endphp
					...
					<div class="alltest-box">
						...
						<div>
							@if($r->image == null) 
							@else
							<img class="_1xG27" src="{{asset($r->image)}}" alt="Package" width="150px">
							@endif 
							<div class="alltest-content">
								<div class="alltest-heading">{{$r->package_name}}</div>
								<!-- <div class="alltest-p">By Apple diagnostics by Ambrish Mehta </div> -->
								<div tabindex="0" role="button" class="_2tdEn _2uX0L _1b_3-"><div class="">Includes {{ count($package_id)}} tests</div>
								<div class="tKMWl">Show all</div></div>
